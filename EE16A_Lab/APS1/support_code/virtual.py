...
def test(cross_correlation, identify_peak, arrival_time, test_num):
    ...
    if test_num == 3:
        ...
        if not test:
            print("Test {0} {1} Failed: Your offsets [{2},{3}], Correct offsets [103,336]".format(test_num, test_cases[test_num], your_result1, your_result2))
        else: print("Test {0} {1} Passed: Your offsets [{2},{3}], Correct offsets [103,336]".format(test_num, test_cases[test_num], your_result1, your_result2))
